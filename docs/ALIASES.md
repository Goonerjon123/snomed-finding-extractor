...
The importer also derives safe runtime variants from those official descriptions: leading acronyms such as `SOB` and `SOBOE`, and phrase variants such as `short of breath` from `Shortness of breath`.
