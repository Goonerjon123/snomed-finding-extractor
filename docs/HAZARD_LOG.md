...
| H-010 | Examination phrase maps to wrong finding | Local shorthand such as "chest clear" is interpreted too broadly | Incorrect examination finding suggestion | Medium | Refset-bounded matching, terminology-derived context trimming only from official descriptions, suppression rules, clinician confirmation | Open |
