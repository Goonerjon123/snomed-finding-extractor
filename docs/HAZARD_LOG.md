...
| H-004 | Ambiguous abbreviation is matched incorrectly | Common acronym overlap | Incorrect code suggestion | Medium | Ambiguous term blocklist, explicit allow flag | Open |
